              ...
              <div className="pricing14-price10">
                <div className="pricing14-price11">
                  ...
                  <h3 className="pricing14-text108 thq-heading-3">
                    {props.plan1Price ?? (
                      <Fragment>
                        <span className="pricing14-text204">$499</span>
                      </Fragment>
                    )}
                  </h3>
                  <p className="thq-body-large">
                    {props.plan1Yearly ?? (
                      <Fragment>
                        <span className="pricing14-text199">$4999</span>
                      </Fragment>
                    )}
                  </p>
                </div>
              ...
              <div className="pricing14-price12">
                <div className="pricing14-price13">
                  ...
                  <h3 className="pricing14-text115 thq-heading-3">
                    {props.plan2Price ?? (
                      <Fragment>
                        <span className="pricing14-text188">$999</span>
                      </Fragment>
                    )}
                  </h3>
                  <p className="thq-body-large">
                    {props.plan2Yearly ?? (
                      <Fragment>
                        <span className="pricing14-text168">$9999</span>
                      </Fragment>
                    )}
                  </p>
                </div>
              ...
              <div className="pricing14-price14">
                <div className="pricing14-price15">
                  ...
                  <h3 className="pricing14-text123 thq-heading-3">
                    {props.plan3Price ?? (
                      <Fragment>
                        <span className="pricing14-text155">$1499</span>
                      </Fragment>
                    )}
                  </h3>
                  <p className="thq-body-large">
                    {props.plan3Yearly ?? (
                      <Fragment>
                        <span className="pricing14-text194">$14999</span>
                      </Fragment>
                    )}
                  </p>
                </div>
